...
public class DateTime01 {
    public static void main(String[] args) {
        ...
        System.out.println(dtf1.format(LocalDate.now())); // 07/Jan/2023

        DateTimeFormatter dtf2 = DateTimeFormatter.ofPattern("dd/MMMM/yyyy");
        System.out.println(dtf2.format(LocalDate.now())); // 07/January/2023

        DateTimeFormatter dtf3 = DateTimeFormatter.ofPattern("dd/M/yyyy");
        System.out.println(dtf3.format(LocalDate.now())); // 07/1/2023
