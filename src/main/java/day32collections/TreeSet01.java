...
public class TreeSet01 {
    public static void main(String[] args) {
        ...
        System.out.println(hts); // [32, 3, 8, 25, 12] ===> Random ===> Rastgele
        long three = System.nanoTime();

        System.out.println("TreeSet in uygulama suresi: " + (two - one));
        System.out.println("HashSet in uygulama suresi: " + (three - two));

        // TreeSet eleman eklemede cook yavastir. HashSet ise coook hizlidir.
        // TreeSet'in bu negetif yonunden kurtulmak icin; HshSet olusturur elemanlari ekler, ve sonra TreeSet'e ceviririz
        ...
        System.out.println(floor1); // 12 --> 15 elemanlardan biri degil. O yuzden 15 ten bir onceki eleman yazildi.

        // floor metodunda kullanabileceginiz sayi en kucuk elemandan az olamaz.

        int floor2 = ts.floor(12);
        System.out.println(floor2); // 12 --> 12 elemanlardan biri o yuzden 12 direct yazdirildi

        // "ceiling()" method'unda kullanabilceginiz sayi en buyuk elemandan fazla olamaz.
        int ceilling1 = ts.ceiling(15);
        System.out.println(ceilling1); // 25 --> 25 elemanlardan biri degil. O yuzden 25 ten bir sonraki eleman yazildi.

        int ceilling2 = ts.ceiling(25);
        System.out.println(ceilling2); //25 --> 25 elemanlardan biri o yuzden 25 direct yazdirildi
        ...
        // Generic method : Normal methodlar paramatrelerde belirtilen data type'lari ile calisir.
        //                  Generic method'lar ise verilen her turlu data type ile calisma becerisine sahiptir
        //
